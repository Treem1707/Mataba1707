...
const AboutWhy = (props: Props) => {
  return (
    ...
    <div className="grid grid-cols-2 max-w-7xl mx-auto py-16">
      <div className="col-span-1 flex flex-col space-y-6 border-pink-900">
        ...
        <p className="text-sm text-slate-400 font-medium max-w-sm">
          Experience transformative education with us. Empowering students
          to thrive in a changing world through innovative teaching,
          experiential learning, and a supportive community. Unleash your
          potential today.
        </p>
