...
const AboutIntroSection = (props: Props) => {
  return (
    <div className="bg-slate-50 w-full py-16 px-4">
      <div className="max-w-7xl w-full mx-auto flex md:flex-row flex-col">
        <img src={about_intro} alt="about intro" className="md:w-1/3 w-full" />
        <div className="md:w-2/3 w-full flex flex-col space-y-2">
          ...
          <p className="text-sm font-medium text-slate-400 max-w-xl">
            Welcome to our academic community on our website! We're thrilled to
            have you join us in this vibrant space for knowledge and growth.
            Connect with fellow students, researchers, and educators, and engage
